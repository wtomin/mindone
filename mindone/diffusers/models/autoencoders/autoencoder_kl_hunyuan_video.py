...
class HunyuanVideoUpsampleCausal3D(nn.Cell):
    ...
    def construct(self, hidden_states: Tensor) -> Tensor:
        ...
        if num_frames > 1:
            ...
            other_frames = self.ms_interpolate(other_frames, scale_factor=self.upsample_factor, mode="nearest")
...
class HunyuanVideoResnetBlockCausal3D(nn.Cell):
    def __init__(
        ...
        self.norm2 = GroupNorm(groups, out_channels, eps=eps, affine=True)
...
class AutoencoderKLHunyuanVideo(ModelMixin, ConfigMixin):
    ...
    def encode(
        self, x: Tensor, return_dict: bool = False
    ...
    def _decode(self, z: Tensor, return_dict: bool = False) -> Union[DecoderOutput, Tensor]:
    ...
    def decode(self, z: Tensor, return_dict: bool = False) -> Union[DecoderOutput, Tensor]:
        r"""
    ...
    def tiled_decode(self, z: Tensor, return_dict: bool = False) -> Union[DecoderOutput, Tensor]:
        r"""
    ...
    def _temporal_tiled_decode(self, z: Tensor, return_dict: bool = False) -> Union[DecoderOutput, Tensor]:
        batch_size, num_channels, num_frames, height, width = z.shape
        ...
        for i in range(0, num_frames, tile_latent_stride_num_frames):
            ...
            if self.use_tiling and (tile.shape[-1] > tile_latent_min_width or tile.shape[-2] > tile_latent_min_height):
                decoded = self.tiled_decode(tile, return_dict=return_dict)[0]
            else:
                tile = self.post_quant_conv(tile)
                decoded = self.decoder(tile)
            if i > 0:
