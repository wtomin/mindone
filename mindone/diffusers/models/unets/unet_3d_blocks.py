...
from ...utils.mindspore_utils import apply_freeu
    ...
    def construct(
        ...
        **kwargs,
        ...
        if len(args) > 0 or kwargs.get("scale", None) is not None:
            ...
            " Please remove it, as passing it will raise an error in the future. `scale` "
            "should directly be passed while calling the underlying pipeline component "
