...
class Cohere2Config(PretrainedConfig):
    ...
    with the defaults will yield a similar configuration to that of the [CohereForAI/c4ai-command-r-v01]\
        (https://huggingface.co/CohereForAI/c4ai-command-r-v01) model.
