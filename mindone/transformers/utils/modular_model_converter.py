...
class ModuleMapper(CSTVisitor, ABC):
    ...
    def __init__(self, python_module: cst.Module):
        ...
        self.object_dependency_mapping = defaultdict(set)          # immediate function/assignment dependency mapping (i.e. \
                                                                    # dependencies immediately in the function/assignment definition)
                    ...
                    if source == "modeling" and "Config" in self.python_module.code_for_node(imported_):
                        raise ValueError(
                            f"You are importing {self.python_module.code_for_node(imported_)} from the modeling file. \
                                Import from the `configuration_xxxx.py` file instead"
                        )
