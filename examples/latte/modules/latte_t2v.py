...
from mindone.models.modules import get_1d_sincos_temp_embed
    ...
    def __init__(
        ...
        if norm_type == "ada_norm_single":
            self.use_additional_conditions = (
                self.config.sample_size[0] == 128
                if isinstance(self.config.sample_size[0], (tuple, list))
                else self.config.sample_size == 128
            )  # False, 128 -> 1024
        ...
        temp_pos_embed = get_1d_sincos_temp_embed(inner_dim, video_length)  # 1152 hidden size
