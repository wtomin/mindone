...
class ConvTransposeNorm(mindspore.nn.SequentialCell):
    """
    Modification of
    ...
    def __init__(
        ...
        super().__init__()
        self.add_module('c',
                        mindspore.mint.nn.ConvTranspose2d(in_chs, out_chs, kernel_size, stride, pad, dilation, groups, bias=False))
        self.add_module('bn', mindspore.mint.nn.BatchNorm2d(out_chs))
    ...
    def fuse(self):
        ...
        m = mindspore.mint.nn.ConvTranspose2d(
            w.shape[1], w.shape[0], w.shape[2:], stride=self.c.stride,
