...
from models import LaVITImageProcessor, LaVITQuestionProcessor, build_model
from PIL import Image
from torch.utils.data import DataLoader, DistributedSampler
from tqdm import tqdm
from utils import get_rank, is_main_process, save_result
...
def report_vqa_metrics(result_file, ques_file, anno_file):
    ...
    vqa_result = vqa.loadRes(resFile=result_file, quesFile=ques_file)
...
def eval_vqa(args):
    ...
    model = build_model(model_path=model_path, model_dtype=model_dtype, local_files_only=True, understanding=True)
